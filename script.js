...
redips.configuration = function () {
	...
	redips.component =	'<table class="nolayout cHeader"><tr><td class="hLeft" onclick="redips.details(this)">+</td><td class="hLabel"></td><td class="hTitle">|</td><td class="hRight" onclick="redips.divDelete(this)">x</td></tr></table>' +
...
redips.details = function (el, type) {
	...
	// hide component details
		...
		var obj = div.getElementsByTagName("input")[0];
		if(obj.value != '')
